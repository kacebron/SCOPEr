...
#'
#' @param SCOPE_path file path where SCOPE.m is located in your computer.
...
#'
#' @examples
#' run_scope(SCOPE_path = "~/Documents/1_postdoc_projects/1_serc_nasa_roses/02_projects/SCOPE/SCOPE.m")

run_scope <- function(SCOPE_path) {
  print(getwd()) #just to check where is your current directory
